...
<head>
  ...
  <title>Sign up - PrimeConstruct</title>
</head>
<body>
...
<div class="form-group">
    <label>Username:</label>
      <input type="text" name="username" placeholder="min 3 karaktere" >
    </div>
<div class="form-group">
    <label>Email:</label>
      <input type="text" name="email" placeholder="shembull@domen.com">
</div>
<div class="form-group">
    <label>Telefoni (opsional):</label>
      <input type="tel" name="phone" placeholder="+38344123456">
...
<div class="form-group">
    <label>Fjalëkalimi:</label>
      <input type="password" name="password" placeholder="min 8 (1UC, 1 D, 1 S)">
</div>
<div class="form-group">
    <label>Konfirmo fjalëkalimin:</label>
      <input type="password" name="confirmPassword" placeholder="min 8 (1UC, 1 D, 1 S)">
</div>

    <div class="form-group">
  <label>Gjinia:</label>
  <div class="radio-group">
    <label><input type="radio" name="gender" value="female"> Femër</label>
    <label><input type="radio" name="gender" value="male"> Mashkull</label>
  </div>
</div>
